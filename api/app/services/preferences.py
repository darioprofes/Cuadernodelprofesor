...
def get_preferences() -> Preferences:
    ...
    with get_conn() as conn:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute("SELECT layout_mode, default_calendar_view, grade_scale FROM app_preferences WHERE id = true")
    ...
    with get_conn() as conn:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute(
                ...
                """,
                [merged.layout_mode, merged.default_calendar_view, Json(merged.grade_scale)]
            )
