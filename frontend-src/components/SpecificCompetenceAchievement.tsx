...
const SpecificCompetenceAchievement: React.FC<SpecificCompetenceAchievementProps> = ({ classData, courses, competences, keyCompetences, criteria, academicConfiguration }) => {
    ...
    const studentCompetenceGrades = useMemo(() => {
        ...
        for (const student of classData.students) {
            studentGrades.set(student.id, calculateStudentCompetenceGrades(student.id, classData, criteria, competences, repartoIgual, selectedPeriodId === 'all' ? undefined : selectedPeriodId));
        }
        return studentGrades;
    }, [classData, criteria, competences, repartoIgual, selectedPeriodId]);
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-5 overflow-hidden">
            <div className="flex justify-between items-center mb-4">
                <h2 className={TYPOGRAPHY.pageTitle}>Grado de Consecución de Competencias Específicas</h2>
                 <div>
                    <Select
