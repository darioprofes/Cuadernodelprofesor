...
export const ClipboardDocumentCheckIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5.25H7.5a2.25 2.25 0 00-2.25 2.25v11.25a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25V7.5a2.25 2.25 0 00-2.25-2.25H15m-6 0a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25m-6 0a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25M9 14.25l2.25 2.25 4.5-4.5" />
  </svg>
);
...
// --- Iconos de materia (selector de icono de clase) ---
...
export const MusicNoteIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <line x1="9.5" y1="17" x2="9.5" y2="5" />
    <line x1="18.5" y1="15" x2="18.5" y2="4" />
    <line x1="9.5" y1="5" x2="18.5" y2="4" />
    <line x1="9.5" y1="8.5" x2="18.5" y2="7.5" />
  </svg>
);

export const PaletteIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path d="M12 3C7.03 3 3 6.8 3 11.5 3 15 5.5 17 8 17h1a1.5 1.5 0 011.5 1.5v.5A2 2 0 0012.5 21C17.5 21 21 17 21 12c0-5-4-9-9-9z" />
...
export const LeafIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path d="M6 20c-2-4-2-9 2-13 4-4 9-4 13-2-2 6-6 10-10 12-2 1-3.5 2-5 3z" />
    <path d="M8 18c3-3 6-6 8-10" />
  </svg>
);

export const PhotoIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3 16.5V6a1.5 1.5 0 011.5-1.5h15A1.5 1.5 0 0121 6v12a1.5 1.5 0 01-1.5 1.5h-15A1.5 1.5 0 013 18v-1.5zm10.5-8.25h.008v.008h-.008V8.25z" />
  </svg>
);
