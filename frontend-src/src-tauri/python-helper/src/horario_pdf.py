...
#
# COPIA de api/app/services/horario_pdf.py para el sidecar de escritorio
# (ver frontend-src/src-tauri/python-helper/README.md) -- no hay forma
# limpia de compartir el módulo entre los dos árboles de proyecto (Python
# empaquetado con PyInstaller vs. el backend FastAPI), así que se mantiene
# a mano en sincronía. Si tocas la lógica de extracción en el backend web,
